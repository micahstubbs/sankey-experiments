ensure that the plot begins at the top of the page - don't leave empty space

---

fix the node height as well, and adjust the layout so that links land ("come to shore") inside the new shorter nodes
